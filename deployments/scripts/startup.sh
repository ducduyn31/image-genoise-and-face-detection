...
runuser -l ec2-user -c 'jupyter notebook --generate-config' &&
    sed -i -e "s/#c.NotebookApp.ip = 'localhost'/c.NotebookApp.ip = '0.0.0.0'/g" /home/ec2-user/.jupyter/jupyter_notebook_config.py &&
...
mkdir -p /anaconda3/projects
nohup jupyter notebook --notebook-dir=/anaconda3/projects &